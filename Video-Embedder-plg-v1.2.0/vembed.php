...
class plgSystemVembed extends JPlugin
{
    ...
    $vid = ''; $pf = ''; $replacement = '<div class="embed-responsive-container"><div class="embed-responsive embed-responsive-16by9">';
    ...
    switch($pf) {
      ...
      break;
			case 'b' : // BitChute
				$replacement .= '<iframe class="embed-responsive-item" src="//www.bitchute.com/embed/'.$vid.'" frameborder="0" allowfullscreen scrolling="no"></iframe>';
			break;
			case '1' : // LBRY
				$replacement .= '<iframe class="embed-responsive-item" src="https://lbry.tv/$/embed/'.$vid.'" frameborder="0" allowfullscreen scrolling="no"></iframe>';
			break;
			case '2' : // Brand New Tube
				$replacement .= '<iframe class="embed-responsive-item" src="https://brandnewtube.com/embed/'.$vid.'" frameborder="0" allowfullscreen scrolling="no"></iframe>';
			break;
			case '3' : // Odysee
				$replacement .= '<iframe class="embed-responsive-item" src="https://odysee.com/$/embed/'.$vid.'" frameborder="0" allowfullscreen scrolling="no"></iframe>';
			break;
			case '4' : // Brighteon
				$replacement .= '<iframe class="embed-responsive-item" src="https://www.brighteon.com/embed/'.$vid.'" frameborder="0" allowfullscreen scrolling="no"></iframe>';
			break;
			case '5' : // Flote
				$replacement .= '<iframe class="embed-responsive-item" src="https://ship.sfo2.digitaloceanspaces.com/'.$vid.'" frameborder="0" allowfullscreen scrolling="no"></iframe>';
			break;
			case '6' : // Rumble
				$replacement .= '<iframe class="embed-responsive-item" src="https://rumble.com/embed/'.$vid.'" frameborder="0" allowfullscreen scrolling="no"></iframe>';
			break;
			case 'T' : // Twitch
				$replacement .= '<iframe class="embed-responsive-item" src="https://player.twitch.tv/'.$vid.'&parent=onegreatworknetwork.com" frameborder="0" allowfullscreen scrolling="no"></iframe>';
			break;
    }
